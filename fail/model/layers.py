...
class SO2MLP(nn.Module):
    def __init__(self):
        ...
        self.block1 = enn.SequentialModule(enn.Linear(self.in_type, act1.in_type), act1)
        ...
        self.block2 = enn.SequentialModule(
            enn.Linear(self.block1.out_type, act2.in_type), act2
        )

        self.out_type = self.gspace.type(
            self.G.standard_representation() + self.G.irrep(0)
        )
