...
class BaseDataset(torch.utils.data.Dataset):
  def __init__(self,
    ...
    self.replay_buffer.loadSaveState(
  ...
  def getNormalizer(self, mode='limits', **kwargs):
    data = self._sampleToData(self.replay_buffer)
  ...
  def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
    ...
    data = self._sampleToData(sample)
